...
class AllLocationsArea extends StatelessWidget {
   AllLocationsArea({ Key? key }) : super(key: key);
            ...
            child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return InkWell(
                    onTap: () async {
                      await _viewModel
                          .getLocationDetail(model.allLocations![index])
                          .whenComplete(
